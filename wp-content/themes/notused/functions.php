...
function twentyfifteen_setup() {
	...
	// load translate
	load_theme_textdomain('as-text-domain', get_template_directory() . '/languages');
	...
	register_nav_menus(array(
		'main' => __('Main Menu', 'as-text-domain'),
		'side' => __('Side Menu', 'as-text-domain'),
	));
