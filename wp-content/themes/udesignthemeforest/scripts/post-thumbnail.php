...
if ( function_exists('get_the_image') ) { 
	...
	echo ( $the_thumb_html_as_array[src] ) ? '<span class="small-custom-frame alignleft'.$shadow_class.'"><a href="'.get_permalink().'" title="'.the_title('', '', false).'"><img src="'.get_bloginfo("template_directory").'/scripts/timthumb.php?src='.$the_thumb_html_as_array[url].'&amp;w='.$post_thumb_width.'&amp;h='.$post_thumb_height.'&amp;zc=1&amp;q=100" width="'.$post_thumb_width.'" height="'.$post_thumb_height.'" alt="'.$the_thumb_html_as_array[alt].'" /></a></span>' : '';
