...
$google_webfonts = array('Abel','Abril+Fatface','Aclonica','Acme','Actor','Adamina','Aguafina+Script','Aladin','Aldrich','Alegreya','Alegreya+SC','Alex+Brush','Alfa+Slab+One','Alice','Alike','Alike+Angular','Allan:bold','Allerta','Allerta+Stencil','Allura','Almendra','Almendra+SC','Amaranth','Amatic+SC','Amethysta','Andada','Andika','Annie+Use+Your+Telescope','Anonymous+Pro','Antic','Anton','Arapey','Arbutus','Architects+Daughter','Arimo','Arizonia','Armata','Artifika','Arvo','Asap','Asset','Astloch','Asul','Atomic+Age','Aubrey','Bad+Script','Balthazar','Bangers','Basic','Baumans','Belgrano','Bentham','Bevan','Bigshot+One','Bilbo','Bilbo+Swash+Caps','Bitter','Black+Ops+One','Bonbon','Boogaloo','Bowlby+One','Bowlby+One+SC','Brawler','Bree+Serif','Bubblegum+Sans','Buda:light','Buenard','Butcherman','Butcherman+Caps','Cabin','Cabin+Condensed','Cabin+Sketch','Cabin+Sketch:bold','Cabin:bold','Caesar+Dressing','Cagliostro','Calligraffitti','Cambo','Candal','Cantarell','Cardo','Carme','Carter+One','Caudex','Cedarville+Cursive','Ceviche+One','Changa+One','Chango','Chelsea+Market','Cherry+Cream+Soda','Chewy','Chicle','Chivo','Coda','Coda:800','Comfortaa','Coming+Soon','Condiment','Contrail+One','Convergence','Cookie','Copse','Corben','Corben:bold','Cousine','Coustard','Covered+By+Your+Grace','Crafty+Girls','Creepster','Creepster+Caps','Crete+Round','Crimson','Crushed','Cuprum','Damion','Dancing+Script','Dawning+of+a+New+Day','Days+One','Delius','Delius+Swash+Caps','Delius+Unicase','Devonshire','Didact+Gothic','Diplomata','Diplomata+SC','Dorsa','Dr+Sugiyama','Droid+Sans','Droid+Sans+Mono','Droid+Serif','Duru+Sans','Dynalight','EB+Garamond','Eater','Eater+Caps','Electrolize','Emblema+One','Engagement','Enriqueta','Erica+One','Esteban','Euphoria+Script','Ewert','Exo','Expletus+Sans','Fanwood+Text','Fascinate','Fascinate+Inline','Federant','Federo','Felipa','Fjord+One','Flamenco','Flavors','Fondamento','Fontdiner+Swanky','Forum','Francois+One','Fredericka+the+Great','Fresca','Frijole','Fugaz+One','Galdeano','Gentium+Basic','Gentium+Book+Basic','Geo','Geostar','Geostar+Fill','Germania+One','Give+You+Glory','Glegoo','Gloria+Hallelujah','Goblin+One','Gochi+Hand','Goudy+Bookletter+1911','Gravitas+One','Gruppo','Gudea','Habibi','Hammersmith+One','Handlee','Herr+Von+Muellerhoff','Holtwood+One+SC','Homemade+Apple','Homenaje','IM+Fell','Iceberg','Iceland','Inconsolata','Inder','Indie+Flower','Inika','Irish+Growler','Istok+Web','Italianno','Jim+Nightshade','Jockey+One','Josefin+Sans','Josefin+Sans','Josefin+Slab','Judson','Julee','Junge','Jura','Just+Another+Hand','Just+Me+Again+Down+Here','Kameron','Kaushan+Script','Kelly+Slab','Kenia','Knewave','Kotta+One','Kranky','Kreon','Kristi','La+Belle+Aurore','Lancelot','Lato','League+Script','Leckerli+One','Lekton','Lemon','Lilita+One','Limelight','Linden+Hill','Lobster','Lobster+Two','Lora','Love+Ya+Like+A+Sister','Loved+by+the+King','Luckiest+Guy','Lusitana','Lustria','Macondo','Macondo+Swash+Caps','Magra','Maiden+Orange','Mako','Marck+Script','Marko+One','Marmelad','Marvel','Mate','Mate+SC','Maven+Pro','Meddon','MedievalSharp','Medula+One','Megrim','Merienda+One','Merriweather','Metamorphous','Metrophobic','Michroma','Miltonian','Miltonian+Tattoo','Miniver','Miss+Fajardose','Miss+Saint+Delafield','Modern+Antiqua','Molengo','Monofett','Monoton','Monsieur+La+Doulaise','Montaga','Montez','Montserrat','Mountains+of+Christmas','Mr+Bedford','Mr+Bedfort','Mr+Dafoe','Mr+De+Haviland','Mrs+Saint+Delafield','Mrs+Sheppards','Muli','Neucha','Neuton','News+Cycle','Niconne','Nixie+One','Nobile','Norican','Nosifer','Nosifer+Caps','Noticia+Text','Nova+Round','Numans','Nunito','Oldenburg','Open+Sans','Open+Sans+Condensed:700','Orbitron','Original+Surfer','Oswald','Over+the+Rainbow','Overlock','Overlock+SC','Ovo','PT+Sans','PT+Sans+Narrow','PT+Serif','PT+Serif+Caption','Pacifico','Parisienne','Passero+One','Passion+One','Patrick+Hand','Patua+One','Paytone+One','Permanent+Marker','Petrona','Philosopher','Piedra','Pinyon+Script','Plaster','Play','Playball','Playfair+Display','Podkova','Poller+One','Poly','Pompiere','Port+Lligat+Sans','Port+Lligat+Slab','Prata','Prociono','Puritan','Quantico','Quattrocento','Quattrocento+Sans','Questrial','Quicksand','Qwigley','Radley','Raleway:100','Rammetto+One','Rancho','Rationale','Redressed','Reenie+Beanie','Ribeye','Ribeye+Marrow','Righteous','Rochester','Rock+Salt','Rokkitt','Ropa+Sans','Rosario','Rouge+Script','Ruda','Ruge+Boogie','Ruluko','Ruslan+Display','Ruthie','Sail','Salsa','Sancreek','Sansita+One','Sarina','Satisfy','Schoolbell','Shadows+Into+Light','Shanti','Share','Shojumaru','Short+Stack','Sigmar+One','Signika','Signika+Negative','Sirin+Stencil','Six+Caps','Slackey','Smokum','Smythe','Sniglet:800','Snippet','Sofia','Sonsie+One','Sorts+Mill+Goudy','Sorts+Mill+Goudy','Special+Elite','Spicy+Rice','Spinnaker','Spirax','Squada+One','Stardos+Stencil','Stint+Ultra+Condensed','Stoke','Sue+Ellen+Francisco','Sunshiney','Supermercado+One','Swanky+and+Moo+Moo','Syncopate','Tangerine','Telex','Tenor+Sans','Terminal+Dosis','Terminal+Dosis+Light','The+Girl+Next+Door','Tienne','Tinos','Titan+One','Trade+Winds','Trochut','Trykker','Tulpen+One','Ubuntu','Ubuntu+Condensed','Ubuntu+Mono','Ultra','Uncial+Antiqua','UnifrakturCook:bold','UnifrakturMaguntia','Unkempt','Unlock','Unna','VT323','Varela','Varela+Round','Vast+Shadow','Vibur','Vidaloka','Viga','Volkhov','Vollkorn','Voltaire','Waiting+for+the+Sunrise','Wallpoet','Walter+Turncoat','Wellfleet','Wire+One','Yanone+Kaffeesatz','Yellowtail','Yeseva+One','Yesteryear','Zeyada');
...
class UDESIGN_Theme_Options {
	...
	function on_load_page() {
		...
		wp_enqueue_style('uploadify-style', get_template_directory_uri().'/scripts/admin/uploadify/uploadify.css', false, '2.1.4', 'screen');
		wp_register_script('swfobject', get_template_directory_uri().'/scripts/admin/uploadify/swfobject.js', array('jquery'), '2.2', false );
		wp_enqueue_script('swfobject');
		wp_register_script('jquery.uploadify', get_template_directory_uri().'/scripts/admin/uploadify/jquery.uploadify.min.js', array('jquery'), '2.1.4', false );
	...
	function udesign_generate_options_page() {
		...
		<div id="udesign-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding-top:25px;"><?php printf( __('Options <small>(version %1$s)</small>', 'udesign'), '1.5.1' ); ?></h2>
<?php 
					...
					<label for="c2_slide_link_target_999" class="link-target">
						...
						<select name="udesign_options[c2_slide_link_target_999]" id="c2_slide_link_target_999">
						    ...
						    <option value="blank"><?php esc_attr_e('blank', 'udesign'); ?></option>
                                        ...
                                        <div style="display:inline-block;">
                                            <label for="c2_slide_link_target_999" class="slide-alt-tag" style="margin-left:10px;"><?php esc_html_e('Alt Tag:', 'udesign'); ?> </label>
                                            <input name="udesign_options[c2_slide_link_target_999]" type="text" id="c2_slide_link_target_999" value="" size="20" />
                                        </div>
				    </div>
				    <div class="slide-info-text" style="padding:10px 5px 0 0; width:60%; float:left; display:inline;">
					<strong><?php esc_html_e('Slide text', 'udesign'); ?></strong> <span class="description" style="margin:20px 0;"><?php esc_html_e('(You could use text and/or html)', 'udesign'); ?></span>:<br />
...
<?php				endforeach; ?>
		...
		<div class="form-table" style="background-color:#F9F9F9; border:1px solid #DDDDDD; margin-bottom:5px;">
		    <p style="padding:20px 5px 10px;"><?php esc_html_e('The following settings refer to the individual portfolio item post (single post view)', 'udesign'); ?></p>
		    <table>
			<tbody>
			    <tr valign="top">
